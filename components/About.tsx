...
const About = () => {
  ...
  return (
      <div id='what' className='relative md:flex md:flex-row items-center justify-center w-full p-20 px-5 mt-10'>
        ...
        <Separator/>
        <h1 className='font-bold text-4xl md:mt-8 mt-5 md:text-6xl tracking-tighter items-center flex'>At InternPro, We specialize at creating Career and increase high chances of Recruiting in MNC's.</h1>
